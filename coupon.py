    ...
    <div class="banner inner-bg-w3" id="home">
        ...
        <div class="banner-top">
            ...
            <div class="contact-bnr-w3-agile">
                <ul>
                    <li><i class="fa fa-envelope" aria-hidden="true"></i><a href="mailto:asansolpizzaria@gmail.com">asansolpizzaria@gmail.com</a></li>
                    ...
                    <nav class="navbar navbar-default">
						...
						<span class="icon-bar"></span>
                            ...
                            <div class="w3_navigation_pos">
                                <h1 style="text-align: center"><br><a href="index.html"><span>A</span>sansol <span>P</span>izzaria<br></a></h1>
                            </div>
                        </div>
